...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-obsidian text-white overflow-x-hidden">
      ...
      {/* Hero Section - Three Column Structure */}
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
                ...
                className="text-lg font-text text-gray-300"
          >
                hey, i am
              </motion.p>
            ...
            <motion.div
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-0.5 bg-electric-purple"></div>
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white font-heading leading-tight">
              ...
              >
                <Link href="#contact">
                  <Button 
                    variant="outline" 
                    className="border-electric-purple text-electric-purple hover:bg-electric-purple hover:text-white px-6 py-3 text-lg font-semibold rounded-lg transition-all duration-300"
                  >
                    contact me
                  </Button>
                </Link>
              ...
              <motion.div
                ...
                className="space-y-3"
              >
                <p className="text-sm font-text text-gray-400">my socials</p>
                <div className="flex items-center gap-4">
                  <motion.a
                    href="https://linkedin.com/in/taimoor"
                    target="_blank"
                    rel="noopener noreferrer"
                    whileHover={{ scale: 1.2, color: "#8B5CF6" }}
                    className="text-gray-400 hover:text-electric-purple transition-colors duration-300"
                  >
                  ...
                  <motion.a
                    href="https://github.com/TaimoorBasit"
                    target="_blank"
                    rel="noopener noreferrer"
                    whileHover={{ scale: 1.2, color: "#8B5CF6" }}
                    className="text-gray-400 hover:text-electric-purple transition-colors duration-300"
            ...
            >
              ...
              >
                ...
                animate={{ 
                  ...
                  className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-electric-purple rounded-full flex items-center justify-center relative overflow-hidden"
                >
                  {/* Coding Avatar Image */}
                  <motion.div
                    initial={{ opacity: 0 }}
                  ...
                  >
                    <Image
                      src="/coding-avatar.png"
                      alt="Muhammad Taimoor - Developer"
                      width={400}
                      height={400}
                ...
                transition={{ 
                    ...
                    className="absolute -top-4 -right-4 w-8 h-8 bg-electric-purple rounded-full opacity-60"
                  />
              <motion.div 
                animate={{ 
                      rotate: -360,
            ...
            <motion.div
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8, delay: 0.6 }}
              className="space-y-6 text-left lg:text-right"
            >
              {/* Role */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
                ...
                className="space-y-2"
              >
                <p className="text-sm font-text text-gray-400 uppercase tracking-wider">FULLSTACK</p>
              ...
              <motion.p 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 1.0 }}
                className="text-gray-300 font-text leading-relaxed max-w-md lg:ml-auto"
              >
                {aboutData?.description || 'I specialize in creating modern, responsive web applications using cutting-edge technologies. From e-commerce solutions to dynamic web platforms, I bring ideas to life with clean code and exceptional user experiences.'}
              </motion.p>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
                ...
                className="flex flex-col lg:items-end space-y-2"
              >
                <div className="flex items-center gap-4">
                  <Link href="#projects" className="text-gray-400 hover:text-electric-purple transition-colors duration-300">
                    my Work
                  </Link>
                  <div className="w-px h-4 bg-gray-600"></div>
                  <Link href="#skills" className="text-gray-400 hover:text-electric-purple transition-colors duration-300">
                    my Skills
                  </Link>
                  <div className="w-px h-4 bg-gray-600"></div>
                  <Link href="#testimonials" className="text-gray-400 hover:text-electric-purple transition-colors duration-300">
                    my Art
                  </Link>
                </div>
              </motion.div>
              ...
              >
                <p className="text-sm font-text text-gray-400">my life motto is -</p>
                <div className="flex items-center gap-3 lg:justify-end">
                  <div className="w-8 h-px bg-electric-purple"></div>
                  <p className="text-lg font-text text-white italic">
