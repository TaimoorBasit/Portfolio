    ...
    <div className="min-h-screen bg-obsidian text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 md:px-8">
          ...
          <motion.div
            ...
            <motion.div
              ...
              >
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white font-heading leading-tight">
                  {aboutData?.name || 'Muhammad Taimoor'}
                </h1>
            </motion.div>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
                ...
                className="space-y-4"
              >
                <h2 className="text-2xl md:text-3xl font-semibold text-electric-purple">
            ...
            <motion.div
              ...
              >
                <Link href="#projects">
                  <Button className="bg-electric-purple hover:bg-electric-purple-dark text-white px-8 py-3 text-lg font-semibold rounded-lg transition-all duration-300 shadow-lg hover:shadow-purple-500/25">
                    View My Work
                  </Button>
                </Link>
                <Link href="#contact">
                  <Button variant="outline" className="border-electric-purple text-electric-purple hover:bg-electric-purple hover:text-white px-8 py-3 text-lg font-semibold rounded-lg transition-all duration-300">
                    Get In Touch
                  </Button>
                </Link>
              </motion.div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-electric-purple/20 to-purple-600/20 rounded-full blur-xl"></div>
                  
                  {/* Profile Image */}
                  <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-electric-purple/30 shadow-2xl">
                  ...
                  <motion.div
                    ...
                    className="absolute -top-4 -right-4 w-8 h-8 border-2 border-electric-purple/50 rounded-full"
                  />
                  <motion.div
                    animate={{ rotate: -360 }}
                    transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
                    className="absolute -bottom-4 -left-4 w-6 h-6 border-2 border-electric-purple/30 rounded-full"
                  />
              </motion.div>
            </motion.div>
          </motion.div>
        ...
        >
            ...
            className="w-6 h-10 border-2 border-electric-purple/50 rounded-full flex justify-center"
          >
            <motion.div
              animate={{ y: [0, 10, 0] }}
              transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
